...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={`fixed z-50 flex-row justify-between items-center text-black h-[16vh] py-20 md:px-[10%] px-4 backdrop-blur-xl rounded-md w-full transition-transform duration-300 hidden sm:flex-row sm:flex ${
